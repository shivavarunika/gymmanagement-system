...
//   useEffect(() => {
//     // Fetch packages from an API or local storage
//     const fetchedPackages = JSON.parse(localStorage.getItem('packages')) || [];
...
//     // Add new package to the local storage
...
//           <div className="mb-4">
//             <label className="block text-lg font-semibold">Package Name</label>
//             <input
//               type="text"
...
//           <div className="mb-4">
//             <label className="block text-lg font-semibold">Package Price</label>
//             <input
//               type="number"
//               className="form-input w-full p-2 border rounded"
...
//           <div className="mb-4">
//             <label className="block text-lg font-semibold">Package Description</label>
//             <textarea
//               className="form-input w-full p-2 border rounded"
